...
These workflow files serve as templates to help users get started with GitHub Actions. They appear when you begin creating a new GitHub Actions workflow.
